...
<img src="<?= ASSETS . THEME ?>images/hero/digital-marketing.png" alt="hero image" class="img-fluid"/>
</div>
</div>
</div>
</div>
        ...
        <div class="container">
            ...
            <div class="-cta-btn mt70">
                <div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.2s">
                    ...
                    <a href="https://wa.me/2349031499108" class="btn-main bg-btn2 lnk">Let's Work Together<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                </div>
            </div>
        </div>
...
<div class="col-md-6"><input type="text" name="first_name" placeholder="Full Name" name="name"></div>
<div class="col-md-6"><input type="email" placeholder="Email Address" name="email"></div>
</div>
<div class="fieldsets row">
<div class="col-md-6"><input type="number" name="phone" placeholder="Contact Number" name="phone"></div>
<div class="col-md-6"><input type="text" name="subject" placeholder="Subject" name="subject"></div>
</div>
...
<img src="<?= ASSETS . THEME ?>images/about/hellopic.png" alt="enquire" class="img-fluid" />
</div>
</div>
</div>
</div>
