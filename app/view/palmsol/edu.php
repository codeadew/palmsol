        ...
        <div class="row">
            <div class="col-lg-6 v-center">
                <div class="about-image">
                    <img src="images/about/edu.png" alt="Education" class="img-fluid"/>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Distance Learning Programs</h4>
                        <p>Share the educational content with the students and enable them with a better learning opportunity.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Candidate Online Training portal</h4>
                        <p>Deliver the online training to the learners situated far from you with our easy-to-integrate solutions.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Teaching software</h4>
                        <p>All-inclusive easy-to-use-and-integrate software that powers the teachers to focus on improved teaching.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Test paper Evaluation Software</h4>
                        <p>Let your candidates get assessed fairly above any favoritism with our Test Paper Evaluation Software. </p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Examination Management Software</h4>
                        <p>Manage the various examination related tasks and have streamlined processes.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>M-Learning mobile application</h4>
                        <p>Everything is getting mobile and so it’s imperative to have learning mobile too.</p>
                    </div>
                </div>
            </div>
        </div>
