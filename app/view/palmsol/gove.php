        ...
        <div class="row">
            <div class="col-lg-6 v-center">
                <div class="about-image">
                    <img src="images/about/gov.png" alt="Government" class="img-fluid"/>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="common-heading text-l ">
                    ...
                    <p>By 2030, we predict that many public sector organizations will take advantage of new technologies and breakthrough innovations to become more proactive, automated, foresighted, data-driven, and citizen-focused.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading ptag">
                    ...
                    <p class="mb30">Digital technologies are bringing transformative change to society.</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Policy to Operation</h4>
                        <ul>
                            <li>Public Sector Budget Planning</li>
                            <li>Data-Driven Policy Design</li>
                            <li> Policy Portfolio Management</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Operation to Outcome</h4>
                        <ul>
                            <li> State e-budgeting</li>
                            <li>Electronic Document management system</li>
                            <li>Collection, Revenue, and Taxes compliance</li>
                        </ul>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    ...
                    <div class="s-block-content">
                        <h4>Outcome to Reform </h4>
                        <ul>
                            <li>Digital Cabinet Room </li>
                            <li>Monitoring and evaluation software</li>
