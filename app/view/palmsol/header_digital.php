        ...
        <ul class="navbar-nav d-menu">
         ...
         <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu animate slideIn" aria-labelledby="Services">
            <a class="dropdown-item" href="digital-agency.html">Digital Agency</a>
             <a class="dropdown-item" href="mobile_app.php">Mobile app development</a>
             <a class="dropdown-item" href="web.php">Web design & development</a>
             <a class="dropdown-item" href="digital.php">Digital Marketing</a>
             <a class="dropdown-item" href="digital.php">Scripting</a>
             <a class="dropdown-item" href="vas.php">VAS</a>
             <a class="dropdown-item" href="vas.php">Ict Skills training</a>
             <a class="dropdown-item" href="networking_and_ict_equipment_vendor.php">Networking & ICT vendor</a>
          </div>
        </li>
