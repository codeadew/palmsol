        ...
        <div class="row">
            <div class="col-lg-6 v-center">
                <div class="about-image">
                    <img src="images/about/ab_health.jpg" alt="Healthcare" class="img-fluid"/>
                </div>
            </div>
            <div class="col-lg-6">
                <li class="common-heading text-l ">
                    <h2>Healthcare</h2>
                    <p> WE ARE DESIGNERS, CONTENT CREATOR, AND DIGITAL SOLUTION PROVIDER</p>
                    <p>
                        Electronic records are a must for any medical company that wants to stay on top of its game in the modern healthcare industry and continue to deliver positive health outcomes. Switching to digital gives medical personnel the ability to collect, store, access, observe, analyze the data observed and share patient data in an efficient and secure manner
                    </p>
                    <p>Our team prototypes and develops custom EMR solutions that give your clinical staff access to the whole range of patient data, including basic vitals, medical history, ICD-10 codes, medications, allergies, test results, and more. Increased accessibility makes it easier to track changes over time, promoting precise diagnosing and effective treatment planning.</p>
                    <p>Based on the specifics of your practice, we add and customize functionality to create an EMR system that is perfectly suited to cover your needs. Here are some of the features we commonly work with:</p>
                    <ul class="list-style-">
