<section class="hero-card-web bg-gradient12 shape-bg3">
  <div class="hero-main-rp container-fluid">
    <div class="row">
      ...
      <div class="col-lg-5"><br><br><br><br><br><br>
        <div class="hero-heading-sec">
          <h2 class="wow fadeIn" data-wow-delay="0.3s">
            ...
            <span>Reliable Marketing solution,</span> 
      ...
      <!-- Right Content -->
      <div class="col-lg-7"><br><br><br><br><br><br>
        <div class="hero-content-sec wow fadeIn" data-wow-delay="0.8s">
          <div class="title-hero-oth">
            <p>Your One-Stop Technology Partner <span>for Business Growth in Nigeria.</span></p>
          </div>
        </div>
            ...
            <div class="owl-carousel service-card-prb">
                ...
                <a href="#">
                  <div class="service-card-hh">
                    <div class="image-sr-mm">
                      <img alt="Smart Home Solution" src="<?= ASSETS . THEME ?>/images/service/vr.png">
                    </div>
                    <div class="title-serv-c"><span>Smart Homes</span> Solution</div>
                  </div>
                </a>
              </div>
              ...
              <div class="service-slide card-bg-b" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                <a href="#">
                  <div class="service-card-hh">
                    <div class="image-sr-mm">
                      <img alt="Web App Solution" src="<?= ASSETS . THEME ?>/images/service/app-develop.png">
                    </div>
                    <div class="title-serv-c"><span>Web</span> App Solution</div>
                  </div>
                </a>
              </div>
              ...
              <div class="service-slide card-bg-e" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                <a href="#">
                  <div class="service-card-hh">
                    <div class="image-sr-mm">
                      <img alt="Marketing Solution" src="<?= ASSETS . THEME ?>/images/service/marketing.png">
                    </div>
              ...
              <div class="service-slide card-bg-f" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                <a href="#">
                  <div class="service-card-hh">
                    <div class="image-sr-mm">
                      <img alt="e-Commerce Solution" src="<?= ASSETS . THEME ?>/images/service/ewallet.png">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row upset link-hover shape-num justify-content-center">
                ...
                <div class="col-lg-3 col-sm-6 mt30 shape-loc wow fadeInUp" data-wow-delay="0.4s">
                    <div class="s-block" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                        <div class="s-card-icon"><img src="<?= ASSETS . THEME ?>/images/icons/development.svg" alt="service" class="img-fluid"/></div>
                        <h4>Website Design & Development</h4>
                        <p>Our web design team consists of experienced, in-house designers and developers with expertise in all kinds of web technology We've launched over 30 successful web design projects within a period of two years</p>
                        <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mt30 shape-loc wow fadeInUp" data-wow-delay="0.8s">
                    <div class="s-block mb0" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                        <div class="s-card-icon"><img src="<?= ASSETS . THEME ?>/images/icons/marketing.svg" alt="service" class="img-fluid"/></div>
                        <h4>Digital Marketing Service</h4>
                        <p>LFor local businesses or the company with multiple locations or even the corporation seeking more local customers, a traditional approach to SEO won’t be enough. In fact, marketing to a targeted local audience requires its own unique set of strategies.</p>
                        <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 mt30 shape-loc wow fadeInUp" data-wow-delay="0.6s">
                    <div class="s-block" data-tilt data-tilt-max="5" data-tilt-speed="1000">
                        <div class="s-card-icon"><img src="<?= ASSETS . THEME ?>/images/icons/app.svg" alt="service" class="img-fluid"/></div>
                        <h4>Mobile App Development</h4>
                        <p>With our highly experienced team, we develop iOS applications using only the latest technologies and following the highest standards of Apple’s mobile platform. Code to design we make sure that your app is 100% be suitable for App Market and works flawlessly on all possible i-devices.</p>
                        <a href="javascript:void(0)">Learn More <i class="fas fa-chevron-right fa-icon"></i></a>
                    </div>
                </div>
            </div>
            <div class="-cta-btn mt70">
                <div class="free-cta-title v-center wow zoomInDown" data-wow-delay=".9s">
                    ...
                    <a href="#" class="btn-main bg-btn2 lnk" data-toggle="modal" data-target="#modalform-full">Launch modal<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-4 v-center">
                    <div class="common-heading text-l">
                        ...
                        <h2>Our team is specialized in a wide array of industry vartical</h2>
                    ...
                    <div class="work-card-set">
                        <div  class="icon-set wow fadeIn" data-wow-delay=".2s">
                            <div class="work-card cd1">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-1.png" alt="Industries" /></div>
                                <p>Social Networking</p>
                            </div>
                        </div>
                        <div  class="icon-set wow fadeIn" data-wow-delay=".4s">
                            <div class="work-card cd2">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-2.png" alt="Industries" /></div>
                                <p>Digital Marketing</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay=".6s">
                            <div class="work-card cd3">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-3.png" alt="Industries" /></div>
                                <p>Ecommerce Development</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay=".8s">
                            <div class="work-card cd4">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-4.png" alt="Industries" /></div>
                                <p>Video Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1s">
                            <div class="work-card cd5">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-5.png" alt="Industries" /></div>
                                <p>Banking Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.2s">
                            <div class="work-card cd6">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-6.png" alt="Industries" /></div>
                                <p>Enterprise Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.4s">
                            <div class="work-card cd7">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-7.png" alt="Industries" /></div>
                                <p>Education Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.6s">
                            <div class="work-card cd8">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-8.png" alt="Industries" /></div>
                                <p>Tour and Travels</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="1.8s">
                            <div class="work-card cd9">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-9.png" alt="Industries" /></div>
                                <p>Health Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="2s">
                            <div class="work-card cd10">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-10.png" alt="Industries" /></div>
                                <p>Event & Ticket</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="2.2s">
                            <div class="work-card cd11">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-11.png" alt="Industries" /></div>
                                <p>Restaurant Service</p>
                            </div>
                        </div>
                        <div class="icon-set wow fadeIn" data-wow-delay="2.4s">
                            <div class="work-card cd12">
                                <div class="icon-bg"><img src="<?= ASSETS . THEME ?>/images/icons/icon-12.png" alt="Industries" /></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 v-center">
                    <div class="enquire-image">
                        <img src="<?= ASSETS . THEME ?>/images/about/freelancer.png" alt="enquire" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center t-ctr">
                <div class="col-lg-4 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?= ASSETS . THEME ?>/images/icons/startup.svg" alt="years" class="img-fluid" />
                        </div>
                        <div class="statnumb">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?= ASSETS . THEME ?>/images/icons/team.svg" alt="team" class="img-fluid" />
                        </div>
                        <div class="statnumb">
            ...
            <div class="row small t-ctr">
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?= ASSETS . THEME ?>/images/icons/deal.svg" alt="happy" class="img-fluid" />
                        </div>
                        <div class="statnumb">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?= ASSETS . THEME ?>/images/icons/computers.svg" alt="project" class="img-fluid" />
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?= ASSETS . THEME ?>/images/icons/worker.svg" alt="work" class="img-fluid" />
                        </div>
                        <div class="statnumb">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="statistics mb0">
                        <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                            <img src="<?= ASSETS . THEME ?>/images/icons/customer-service.svg" alt="support" class="img-fluid" />
                        </div>
                        <div class="statnumb">
                            <span>24/7</span>
            ...
            <div class="row">
                <div class="col-lg-6 v-center">
                    <div class="image-block">
                        <img src="<?= ASSETS . THEME ?>/images/about/about-service.png" alt="about" class="img-fluid no-shadow"/>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="common-heading text-l">
        ...
        <div class="container">
            <div class="row justify-content-center ">
                <div class="col-lg-8">
                    <div class="common-heading">
                        <span>Our Work</span>
                        <h2 class="mb0">Our Creative Work</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-8 col-sm-8 mt60 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="isotope_item hover-scale">
                        <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
                            <a href="#"><img src="<?= ASSETS . THEME ?>/images/portfolio/image-d.jpg" alt="image" class="img-fluid" /> </a>
                        </div>
                        <div class="item-info">
                ...
                <div class="col-lg-4 col-sm-4 mt60 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="isotope_item hover-scale">
                        <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
                            <a href="#"><img src="<?= ASSETS . THEME ?>/images/portfolio/image-1.jpg" alt="image" class="img-fluid" /> </a>
                        </div>
                        <div class="item-info">
                ...
                <div class="col-lg-4 col-sm-4 mt60 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="isotope_item hover-scale">
                        <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
                            <a href="#"><img src="<?= ASSETS . THEME ?>/images/portfolio/image-6.jpg" alt="image" class="img-fluid" /> </a>
                        </div>
                        <div class="item-info">
                ...
                <div class="col-lg-8 col-sm-8 mt60 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="isotope_item hover-scale">
                        <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
                            <a href="#"><img src="<?= ASSETS . THEME ?>/images/portfolio/image-c.jpg" alt="image" class="img-fluid" /> </a>
                        </div>
                        <div class="item-info">
                    ...
                    <div class="opl">
                        <ul>
                            <li class=" wow fadeIn" data-wow-delay=".2s">
                                <div class="clients-logo"><img src="<?= ASSETS . THEME ?>/images/client/easy.png" alt="text" class="img-fluid"/></div>
                            </li>
                            <li class=" wow fadeIn" data-wow-delay=".4s">
                                <div class="clients-logo"><img src="<?= ASSETS . THEME ?>/images/client/rapid.png" alt="text" class="img-fluid"/></div>
                            </li>
                            <li class=" wow fadeIn" data-wow-delay=".6s">
                                <div class="clients-logo"><img src="<?= ASSETS . THEME ?>/images/client/aqual.png" alt="text"      class="img-fluid"/></div>
                            </li>
                            <li class=" wow fadeIn" data-wow-delay=".8s">
                                <div class="clients-logo"><img src="<?= ASSETS . THEME ?>/images/client/chronos.png" alt="text" class="img-fluid"/></div>
                            </li>
                            <li class=" wow fadeIn" data-wow-delay="1s">
                                <div class="clients-logo"><img src="<?= ASSETS . THEME ?>/images/client/click.png" alt="text" class="img-fluid"/></div>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-card-a pl25">
                        <div class="testimonial-card">
                            <div class="t-text">
                                <p>The entire palmsoltechnology team was ace in the delivery of our website. their commitment to surpassing expectations and delivering satisfaction has sealed my faith in their professionalism and capability.</p>
                            </div>
                            <div class="client-thumbs mt30">
                                <div class="media v-center">
                                    <div class="user-image bdr-radius"><img src="<?= ASSETS . THEME ?>/images/user-thumb/sam.jpg" alt="girl" class="img-fluid" /></div>
                                    <div class="media-body user-info v-center">
                                        <h5>Adefioye Samson</h5>
                                        <p>CEO of Easypedia Global, <small>lagos, Nigeria</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="testimonial-card">
                            ...
                            <div class="client-thumbs mt30">
                                <div class="media v-center">
                                    <div class="user-image bdr-radius"><img src="<?= ASSETS . THEME ?>/images/user-thumb/emi.jpg" alt="girl" class="img-fluid" /></div>
                                    <div class="media-body user-info">
                                        <h5>Sophia babalola</h5>
                                        <p>Hr at rapidcash 2.0, <small>Lekki, Lagos</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="testimonial-card">
                            ...
                            <div class="client-thumbs mt30">
                                <div class="media v-center">
                                    <div class="user-image bdr-radius"><img src="<?= ASSETS . THEME ?>/images/user-thumb/team-4.jpg" alt="girl" class="img-fluid" /></div>
                                    <div class="media-body user-info">
                                        <h5>Pastor Iyke</h5>
                                        <p>Head of IT at harvesterng International christian centre, <small>Gbagada, Lagos</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center upset shape-numm">
                ...
                <div class="col-lg-4 col-sm-6 shape-loc wow fadeInUp" data-wow-delay=".4s">
                    <div class="office-card">
                        ...
                        <div class="office-text">
                            <h4>Baruwa-ipaja</h4>
                            <p>2, New London Estate, Baruwa-ipaja, Lagos, Nigeria</p>
                            <a href="javascript:void(0)" target="blank" class="btn-outline">View on Map <i class="fas fa-chevron-right fa-icon"></i></a>
                        </div>
                    </div>
                </div>
