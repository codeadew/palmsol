        ...
        <div class="row">
            ...
            <div class="col-lg-8 block-1">
                <div class="common-heading text-l pl25">
                    ...
                    <p>When developing native mobile apps, we make sure that your product’s performance will be flawless. Our experienced iOS and Android teams are ready to create applications for both systems.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="service-block pad-tb light-dark">
    <div class="container">
        ...
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1">
                    <img src="images/process/requir1.png" alt="Process" class="img-fluid"/>
                </div>
            </div>
        ...
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1">
                    <img src="images/process/full.jpg" alt="Process" class="img-fluid"/>
                </div>
            </div>
            <div class="col-lg-7 v-center order2">
                <div class="ps-block">
        ...
        <div class="row upset justify-content-center mt60">
            ...
            <div class="col-lg-4 v-center order1">
                <div class="image-block1">
                    <img src="images/process/pro1.jpg" alt="Process" class="img-fluid"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading">
                    ...
                    <p class="cta-call">Or call us now <a href="tel:+2348164203793"><i class="fas fa-phone-alt"></i> (+234) 8164203793</a></p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from rajeshdoot.com/niwax-demos/html/service-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Mar 2021 13:38:17 GMT -->
</html>