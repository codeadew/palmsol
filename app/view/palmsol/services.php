        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="bread-titlev2">
                    <h1 class="wow fadeInUp" data-wow-delay=".2s">Web & mobile application agency| Digital solution provider</h1>
                    <p class="mt20 wow fadeInUp" data-wow-delay=".4s">We use custom teams to help agencies and business scale their development, design, and digital marketing capabilities. </p>
                    <a href="contact.php" class="btn-main bg-btn2 lnk mt20 wow zoomInDown" data-wow-delay=".6s">Click this button to Talk to Us.<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 block-1">
                <div class="common-heading text-l pl25">
                    <span>Overview</span>
                    <h2>Digital Services for Growing Your Business.</h2>
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="text-l service-desc- pr25">
                    ...
                    <a href="contact.php" class="btn-main bg-btn2 lnk mt30">Request A Quote  <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                </div>
            </div>
            <div class="col-lg-5">
    ...
    <div class="container">
        ...
        <div class="row card-list">
            ...
            <div class="col-lg-4 col-sm-6 single-card-item graphic">
                <div class="isotope_item hover-scale">
                    <div class="item-image">
                        <a href="#"><img src="images/portfolio/digitalmarketing 350x360.png" alt="image" class="img-fluid"/> </a>
                    </div>
                    <div class="item-info">
            ...
            <div class="col-lg-4 col-sm-6 single-card-item website">
                <div class="isotope_item hover-scale">
                    ...
                    <div class="item-info">
                        <h4><a href="#">Products Branding</a></h4>
                        <p>Graphic, Print</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading">
                    ...
                    <p class="cta-call">Or call us now <a href="tel:+2348164203793"><i class="fas fa-phone-alt"></i>+2348164203793</a></p>
                </div>
            </div>
        </div>
    </div>
