...
<!-- Mirrored from rajeshdoot.com/niwax-demos/html/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Mar 2021 13:37:41 GMT -->
<head>
    <meta charset="utf-8"/>
                ...
                <form id="contact-form" method="post" action="#">
                    <div class="fieldsets row">
                        <div class="col-md-12 form-group">
                            <input id="form_name" type="text"  placeholder="E-mail" required="required">
                        </div>
                    </div>
                    <div class="fieldsets row">
                        <div class="col-md-12 form-group">
                            <input id="form_name" type="text"  placeholder="Name" required="required">
                        </div>
                        <div class="col-md-12 form-group">
                    ...
                    <div class="fieldsets row mt20">
                        ...
                        <div class="col-md-6 form-group v-center text-right"><a href="login.php" class="psforgt">Already have account? login.</a>     </div>
                    </div>
                    <hr class="mt30 mb30">
