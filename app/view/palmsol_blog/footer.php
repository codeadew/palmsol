                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Design & Develop by Palmsol Technology
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- project-create init -->
    <script src="<?= ASSETS  ?>admin_assets/js/pages/project-create.init.js"></script>
    <!-- App js -->
  ...
  <!-- Vector map-->
        ...
        <script src="<?= ASSETS ?>admin_assets/libs/choices/choices.min.js"></script>
 <!-- dropzone js -->
    <script src="<?= ASSETS  ?>admin_assets/libs/dropzone/dropzone-min.js"></script>
        <!-- App js -->
         <!-- Vendor scripts -->

<!-- ... other vendor libs ... -->

<!-- Custom app code last -->



        <script src="<?= ASSETS  ?>admin_assets/js/app.js"></script>
        <script src="<?= ASSETS ?>admin_assets/js/custom.js"></script> <!-- your script -->
      <!-- tinymce -->
     
    <script src="<?= ASSETS  ?>admin_assets/js/tinymce/plugins/filemanager/plugin.min.js"></script>




<!-- Place the first <script> tag in your HTML's <head> -->
<script src="https://cdn.tiny.cloud/1/37rcawgsr3c6dnfd1yqrziyb5apk56aain5f93o98b3unhcm/tinymce/8/tinymce.min.js" referrerpolicy="origin" crossorigin="anonymous"></script>

<!-- Place the following <script> and <textarea> tags your HTML's <body> -->
     api_key: 'YOUR_API_KEY',
<!-- Include your local TinyMCE library -->
...
<script>
  tinymce.init({
    selector: 'textarea',
    height: 500,
    api_key: '37rcawgsr3c6dnfd1yqrziyb5apk56aain5f93o98b3unhcm', // 🔹 Replace with your TinyMCE API key

    plugins: [
      // Core editing features
      'anchor', 'autolink', 'charmap', 'codesample', 'emoticons', 'link', 'lists', 'media', 'searchreplace', 'table',
      'visualblocks', 'wordcount', 'fullscreen',
      
      // Premium / trial plugins
      'checklist', 'mediaembed', 'casechange', 'formatpainter', 'pageembed', 'a11ychecker',
      'tinymcespellchecker', 'permanentpen', 'powerpaste', 'advtable', 'advcode', 'advtemplate',
      'ai', 'uploadcare', 'mentions', 'tinycomments', 'tableofcontents', 'footnotes', 'mergetags',
      'autocorrect', 'typography', 'inlinecss', 'markdown', 'importword', 'exportword', 'exportpdf'
    ],

    toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | align lineheight | link media table mergetags | addcomment showcomments | spellcheckdialog a11ycheck typography uploadcare | checklist numlist bullist indent outdent | emoticons charmap | removeformat | fullscreen code preview',
    ...
    uploadcare_public_key: 'e70b17bcccda6dd2c15d',
    ...
    // Optional: keep focus on editor when switching fullscreen
